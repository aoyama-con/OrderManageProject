...
/**
 * 発注更新APIにリクエストする際に設定するパラメータ情報クラス
 * サービスクラスで設定され、APIに渡す
 * 
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public class ParamUpdatePurchaseOrder {
	...
	/* 発注対象商品 */
	private List<ParamUpdatePurchaseOrderProduct> products;

	/* 発注対象店舗 */
	private List<ParamUpdatePurchaseOrderStore> stores;
	...
	public List<ParamUpdatePurchaseOrderProduct> getProducts() {
		return products;
	}

	public void setProducts(List<ParamUpdatePurchaseOrderProduct> products) {
		this.products = products;
	}

	public List<ParamUpdatePurchaseOrderStore> getStores() {
		return stores;
	}

	public void setStores(List<ParamUpdatePurchaseOrderStore> stores) {
		this.stores = stores;
	}
}
